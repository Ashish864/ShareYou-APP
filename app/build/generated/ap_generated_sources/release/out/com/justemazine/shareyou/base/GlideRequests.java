package com.justemazine.shareyou.base;
...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.justemazine.shareyou.base.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.justemazine.shareyou.base.GlideOptions().apply(toSet));
    }
  }
}
